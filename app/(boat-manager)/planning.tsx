...
export default function PlanningScreen() {
  ...
  const handleAppointmentDetails = (appointmentId: string) => {
    router.push(`/request/${appointmentId}`);
  };
  ...
  const validateAppointmentForm = () => {
    ...
    if (withCompany && !selectedCompany) {
  ...
  const handleSaveAppointment = () => {
    ...
    if (withCompany && selectedCompany) {
      newAppointmentComplete.company = {
            ...
            <View style={styles.formSection}>
              ...
              <View style={styles.companyToggleContainer}>
                ...
                <TouchableOpacity 
                  style={[
                    styles.toggleButton, 
                    withCompany ? styles.toggleButtonActive : styles.toggleButtonInactive
                  ]}
                  onPress={toggleWithCompany}
                >
                  <View style={[
                    styles.toggleIndicator, 
                    withCompany ? styles.toggleIndicatorActive : styles.toggleIndicatorInactive
                  ]} />
                </TouchableOpacity>
              </View>
              ...
              {withCompany && (
                ...
                >
                  ...
                  <View style={styles.formFieldContent}>
                    <Text style={styles.formFieldLabel}>Entreprise</Text>
                    <Text style={selectedCompany ? styles.formFieldValue : styles.formFieldPlaceholder}>
              ...
              <View style={styles.appointmentContent}>
                ...
                {appointment.company && (
                  <View style={styles.companyInfo}>
                    ...
                    <Text style={styles.companyName}>{appointment.company.name}</Text>
                  </View>
                )}
